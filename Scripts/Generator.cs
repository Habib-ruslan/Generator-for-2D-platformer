...
public class Generator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        RoomVariant.Add(RoomVariantEnd);
        RoomVariant.Add(RoomVariant2);
        RoomVariant.Add(RoomVariant3);
        RoomVariant.Add(RoomVariant4);
        ...
        switch (Length)
        {
            ...
            case settings.custom: chance = new float[] { Chance1, Chance2, Chance3, 100f - (Chance3+Chance2+Chance1)}; ChanceBooster = chanceBooster; break;
        }
